...
#    Updated: 2026/07/09 12:37:08 by lpieck           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CUBED_SRCS = Main.c \
			...
			Game_Dev/Movements.c Game_Dev/Rotations.c Bonus/Doors.c\
			Map_validity/Flood_fill.c Rendering/rendering.c Rendering/raycasting.c Enemy/enemy.c \
